...
const int HBRIDGE_PIN9   = 9;   // Held LOW
const int HBRIDGE_PIN10  = 10;  // PWM output driven by trim pot
...
void setup() {
  ...
  // Ensure initial direction is set (Pin 9 LOW)
...
void loop() {
  ...
  // Print single line output required for Part 2
